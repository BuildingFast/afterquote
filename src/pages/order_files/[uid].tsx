...
const OrderFiles: NextPage = () => {
  ...
  const updateFileVisibility = api.orderFiles?.updateFileVisibility.useMutation(
    {
      onMutate: () => {
        // Cancel any outgoing refetches (so they don't overwrite our optimistic update)
        void utils.orderFiles.getS3UrlsForOrder.cancel();
        ...
        <div className="flex h-max w-screen flex-col ">
          ...
          <main className="flex min-h-screen w-screen flex-row justify-center ">
            <div className="mx-16 w-screen gap-12 ">
              <OrderNav
                currentPage="order_files"
                currentOrderId={salesOrderUid}
              />
              <div className="mt-4 grid h-5/6 w-full grid-cols-4 gap-2">
                <div className="col-span-1 rounded-lg border shadow-sm ">
                  <section className="flex cursor-pointer flex-col items-center justify-center rounded-lg bg-background p-4 hover:bg-background/90 ">
                    <div
                      {...getRootProps()}
                  ...
                  <Table className="mt-2 max-h-[200px] w-full">
                    ...
                    <TableBody>
                      {orderFilesS3Urls.data
                        ? orderFilesS3Urls.data?.map((s3UrlObject: any) => {
                            return (
                ...
                <div className="max-w-screen h-screen rounded-lg border p-2 shadow-sm">
                  {viewerUrl ? (
